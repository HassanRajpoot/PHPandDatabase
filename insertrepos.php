...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        $stock_quantity = $_POST['P_id'];
        $stock_item = $_POST['p_item'];
        $stock_type = $_POST['p_type'];
        $stock_purchase_price = $_POST['p_price'];
        $stock_sale_price = $_POST['p_sale_price'];
      ...
      if (!$conn){
        ...
        $sql = "INSERT INTO `stock` (`stock_id`, `stock_quantity`, `stock_item`, `stock_type`, `stock_purchase_price`, `stock_sale_price`) VALUES (NULL, '$stock_quantity', '$stock_item', '$stock_type', '$stock_purchase_price', '$stock_sale_price');";
...
<h1>Add item in Stock</h1>
    <form action="insertrepos.php" method="post">
    <div class="form-group">
        <label for="P_id">Product quantity</label>
    ...
    <div class="form-group">
        <label for="p_sale_price">Product sale price</label>
        <input type="text" name="p_sale_price" class="form-control" id="p_sale_price" aria-describedby="emailHelp">
    </div>
