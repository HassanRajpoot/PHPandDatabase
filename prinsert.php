...
<html lang="en">
  ...
  <div class="dropmenu-bar">
    <ul>
        <li class="active"><a href="home.php">Profit/loss</a>
        </li>
...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$conn){
        ...
        $sql = "INSERT INTO `profit_loss` (`id`, `year`, `purchase`, `sale`, `profit`)  VALUES ('$P_id', '$p_item', '$p_type', '$p_price','$sale')";
...
<h1>Add profit per year</h1>
    <form action="prinsert.php" method="post">
    ...
    <div class="form-group">
        <label for="p_item">Year</label>
        <input type="p_item" name="p_item" class="form-control" id="p_item" aria-describedby="emailHelp"> 
        <small id="p_item" class="form-text text-muted">Enter Year</small>
    </div>

    <div class="form-group">
        <label for="p_type">Purchase</label>
        <input type="text" name="p_type" class="form-control" id="p_type" aria-describedby="emailHelp">
    </div>

    <div class="form-group">
        <label for="p_price">Sale</label>
        <input type="text" name="p_price" class="form-control" id="p_price" aria-describedby="emailHelp">
    </div>
    <div class="form-group">
        <label for="p_price">Profi</label>
        <input type="text" name="sale" class="form-control" id="sale" aria-describedby="emailHelp">
    </div>
