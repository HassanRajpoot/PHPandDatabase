...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$conn){
        ...
        $sql = "INSERT INTO `bill_history` (`bill_id`, `no_of_items`, `total_price`) VALUES ('$P_id', '$p_item', '$p_type')";
...
<h1>Add bill</h1>
    <form action="billinsert.php" method="post">
    <div class="form-group">
        <label for="P_id">Bill id</label>
        <input type="text" name="P_id" class="form-control" id="P_id" aria-describedby="emailHelp">
    </div>

    <div class="form-group">
        <label for="p_item">No of item</label>
    ...
    <div class="form-group">
        <label for="p_type">Total price</label>
