...
?>
          ...
          <div class="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
            ...
            <button onclick="document.location='insert1.php'"class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">ADD ITEM</button>
            <br>
            <button onclick="document.location='delete1.php'"class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">DELETE ITEM</button>
            <br>
            <button onclick="document.location='cinsert1.php'"class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">ADD CUSTOMER DETAILS</button>
          </div>
        </div>
      </section>
